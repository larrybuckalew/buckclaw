...
class AgentWorker(Worker):
    ...
    def _get_or_create_session(self, session_id: str):
        ...
        if session_id not in self._sessions:
            ...
            # Check if this cron session has a delivery target -> inject post_message tool
            ...
            if delivery_session_id:
                ...
                # Clone the base registry and add the post_message tool
                ...
                logger.info("Injected post_message tool for cron session %s -> %s", session_id, delivery_session_id)
