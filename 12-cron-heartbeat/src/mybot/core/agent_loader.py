...
@dataclass
class AgentDef:
    """Static definition of an agent (loaded from AGENT.md)."""
    id: str
    name: str
    description: str
    system_prompt: str
...
class AgentLoader:
    ...
    def discover_agents(self) -> list[AgentDef]:
        """Scan the agents directory and return all valid AgentDef objects."""
    ...
    def load(self, agent_id: str) -> AgentDef | None:
        """Load a specific agent by id. Returns None if not found."""
